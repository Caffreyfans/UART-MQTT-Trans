...
const char MQTT_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>MQTT</strong> connected</div>";
const char MQTT_STATUS_OFF[]       PROGMEM = "<div class='msg S'><strong>MQTT</strong> disconnected</div>";
